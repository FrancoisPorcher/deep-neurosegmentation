...
LOGDIR="./logs/train_nn_dbb/"
mkdir -p $LOGDIR
LOGFILE="$LOGDIR/train_nn_dbb_$SLURM_JOB_ID.log"
ERRORFILE="$LOGDIR/train_nn_dbb_$SLURM_JOB_ID.err"
...
nnUNetv2_train 2 3d_fullres all --npz >> $LOGFILE 2>> $ERRORFILE
