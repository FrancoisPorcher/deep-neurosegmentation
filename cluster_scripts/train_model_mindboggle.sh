...
LOGDIR="./logs/train_nn_mindboggle/"
mkdir -p $LOGDIR
LOGFILE="$LOGDIR/train_nn_mindboggle_$SLURM_JOB_ID.log"
ERRORFILE="$LOGDIR/train_nn_mindboggle_$SLURM_JOB_ID.err"
