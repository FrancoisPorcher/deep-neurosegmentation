...
paths = {
    ...
    "ITERATION_1_PATH": f"{base_path}/data/raw/BrainLife/DBB_jakob/iteration_1",
    "ITERATION_2_PATH": f"{base_path}/data/raw/BrainLife/DBB_jakob/iteration_2",
    "ITERATION_3_PATH": f"{base_path}/data/raw/BrainLife/DBB_jakob/iteration_3",
    "PROJ_PATH": f"{base_path}/data/raw/BrainLife/proj-60a14ca503bcad0ad27cada9",
    "PROCESSED_DATA_PATH": f"{base_path}/data/processed",
    "PROCESSED_DBB_DATA_PATH": f"{base_path}/data/processed/dbb",
    "PROCESSED_MINDBOGGLE_DATA_PATH": f"{base_path}/data/processed/mindboggle",
